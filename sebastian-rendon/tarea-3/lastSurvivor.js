...
function lastSurvivor(letters, indices) {
  const lettersArray = letters.split('');
  for (let i = 0; i < indices.length; i++) {
    lettersArray.splice(indices[i], 1);
  }
  ...
  },
  {
    input: [
      ...
      [
        ...
        9, 39, 39, 36, 8, 29, 2, 33, 14, 3, 13, 25, 9, 25, 18, 10, 1, 2, 20, 8,
        2, 11, 5, 7, 0, 10, 10, 8, 12, 3, 5, 1, 7, 7, 5, 1, 4, 0, 4, 0, 0, 1,
      ],
    ],
    answer: 'd',
  },
